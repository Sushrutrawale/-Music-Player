...
class MusicPlayer:
    ...
    def play_song(self,e=None):
        try:
            ...
            print("pygame error:", pygame_err)
            self.next_song()
        except Exception as e:
            print("\nError in play song",type(e).__name__)
            print("\nError in play song",e)
            self.next_song()
...
if __name__ == '__main__':
    ...
    window.iconbitmap(r"C:\Users\Lenovo\OneDrive\Desktop\git repo\Generation_Music_Player\Pictures\music_icon.ico")
    window.geometry("828x515")
    window.maxsize(830,515)
    window.minsize(830,515)
    window.config(bg="#141414")

    backward_image_take = ImageTk.PhotoImage(Image.open(r"C:\Users\Lenovo\OneDrive\Desktop\git repo\Generation_Music_Player\Pictures\backward.png"))
    ...
    play_image_take = ImageTk.PhotoImage(Image.open(r"C:\Users\Lenovo\OneDrive\Desktop\git repo\Generation_Music_Player\Pictures\play.png").resize((40,40),Image.LANCZOS))
    ...
    pause_image_take = ImageTk.PhotoImage(Image.open(r"C:\Users\Lenovo\OneDrive\Desktop\git repo\Generation_Music_Player\Pictures\pause.png"))
    ...
    stop_image_take = ImageTk.PhotoImage(Image.open(r"C:\Users\Lenovo\OneDrive\Desktop\git repo\Generation_Music_Player\Pictures\stop_img_is.png").resize((40,40),Image.LANCZOS))
    ...
    forward_image_take = ImageTk.PhotoImage(Image.open(r"C:\Users\Lenovo\OneDrive\Desktop\git repo\Generation_Music_Player\Pictures\forward.png"))
